...
private static final String CREATE_TABLE_DonHang ="CREATE TABLE DonHang (maDonHang INTEGER PRIMARY KEY AUTOINCREMENT, ngayGioDatHang DATETIME DEFAULT CURRENT_TIMESTAMP, ThanhTien INT, user_id INT, noiGiaoHang TEXT, soDienThoai NVARCHAR(15), phuongThucThanhToan NVARCHAR(20), tenKH NVARCHAR(50),tinhTrangDonHang INT)";

private static final String CREATE_TABLE_PhanHoi = "CREATE TABLE PhanHoi (maPhanHoi INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER, thoiGianPhanHoi DATETIME DEFAULT CURRENT_TIMESTAMP, NoiDungKhachPhanHoi TEXT,NoiDungAdminPhanHoi TEXT, media1 VARCHAR(255), media2 VARCHAR(255), media3 VARCHAR(255), soDienThoai VARCHAR(15), tenKH VARCHAR(255), maDonHang INTEGER, trangThai INTEGER default 0)";
...
private static final String CREATE_TABLE_chitietDonHang="CREATE TABLE chiTietDonHang (maDonHang INT, maSanPham INT, soLuong INT, PRIMARY KEY (maDonHang, maSanPham))";
    ...
    private static final String CREATE_TABLE_GioHang = "CREATE TABLE GIOHANG (maSanPham INT, soLuong INT, id_user INT)";
public MainData(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public MainData(@Nullable Context context) {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
          // Thực hiện câu lệnh tạo bảng
            ...
            sqLiteDatabase.execSQL( CREATE_TABLE_GioHang);
    }
