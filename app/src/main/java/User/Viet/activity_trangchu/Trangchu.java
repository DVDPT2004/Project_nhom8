...
public class Trangchu extends AppCompatActivity {
    ...
    String[] items = {"Món ăn chính", "Món tráng miệng", "Đồ uống"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView = findViewById(R.id.grThucDon);
        autoCompleteTextView = findViewById(R.id.txtdanhmuc);
        ...
        autoCompleteTextView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(getApplicationContext(), "Đây là danh sách: " + item, Toast.LENGTH_SHORT).show();

                // Hiển thị danh sách món ăn dựa trên danh mục
                if (i == 0) { // Món ăn chính
                    initMainDishData();
                } else if (i == 2) { // Đồ uống
                    initDrinkData();
    ...
    private void initMainDishData() {
        ...
        thucDonAdapter = new ThucDonAdapter(this, R.layout.activity_item_thucdon, list);
