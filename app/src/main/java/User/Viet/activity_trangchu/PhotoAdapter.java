...
public class PhotoAdapter extends PagerAdapter {
    ...
    public PhotoAdapter(Context context, List<Photo> photoList) {
        ...
        this.mListPhoto = photoList;
    }

    @NonNull
    @Override
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.activity_layout_anhchay,container,false);
        ImageView imageView=view.findViewById(R.id.imganhchay);
